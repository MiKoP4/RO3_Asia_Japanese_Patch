...
# Development-only diagnostics must never leak into an install release.
$probe = Join-Path $Stage 'payload\BepInEx\plugins\RO3WorldNameplateProbe.dll'
if (Test-Path -LiteralPath $probe) {
    throw "Diagnostic probe unexpectedly present in release payload: $probe"
}
